                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box hover-zoom-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number"><?php echo $nbgrille;?></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card" id="messages">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="#" class="btn bg-red waves-effect" > 50 000</a></li>
                        ...
                        <div class="body" style="font-weight: 12px;">
                            <div class="table-responsive">
                                <table class="table table-bordered  table-hover dataTable js-exportable" style="font-size: 14px; font-family: 'Calibri';">
                                    <thead >
                                         <tr>
                                                ...
                                                while ($res=$req->fetch()) {
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td colspan=\"2\">
                                                            <?php echo"
                                                              <div class=\"btn-group\">
                                                                <a href=\"#envoyerErreur$id\" class=\" btn btn-round btn-info btn-md\" data-toggle=\"modal\" title=\"Envoyer Erreur\">
