<section>
    <aside id="leftsidebar" class="sidebar">
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="?page=listGestionaire" class="menu-toggle">
                                    <span>Liste Gestionnaires</span>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <!-- #Menu -->
            <!-- Footer -->
            <div class="legal" style="background-color: #cc0c05;">
                <div class="copyright">
                    &copy; 2017 - 2018 <a href="javascript:void(0);"">CONQRETE - DCPP</a>.
                </div>
            </div>
            <!-- #Footer -->
        </aside>
