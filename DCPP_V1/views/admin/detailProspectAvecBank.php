                                        ...
                                        foreach ($listBCAO as $reponse) {
                                            ...
                                            echo "
                                              ...
                                              <td></td>
                                                ...
                                                <td>".$reponse['Employeur']."</td>
                                                <td>".$reponse['Disponibilite']."</td>
                                                <td style='background:pink;'>".$reponse['Banque']."</td>
                                                <td><a href=\"?page=listegestionnaire\">Affecter</a></td>
                                                <td><a href=\"#MiseàJour$id\" data-toggle=\"modal\"  ><i class=\"glyphicon glyphicon-new-window\"></i>MiseàJour</a></td>
                                              </tr>";
                                            }
                                            foreach ($listBOA as $reponse) {
                                              $id=$reponse['id'];
                                            echo "
                                              <tr>
                                              <td></td>
                                                ...
                                                <td>".$reponse['Employeur']."</td>
                                                <td>".$reponse['Disponibilite']."</td>
                                                <td style='background:teal;'>".$reponse['Banque']."</td>
                                                <td><a href=\"?page=listegestionnaire\">Affecter</a></td>
                                                <td><a href=\"#MiseàJour$id\" data-toggle=\"modal\"  ><i class=\"glyphicon glyphicon-new-window\"></i>MiseàJour</a></td>
                                              </tr>";
                                            
                                            }
                                            foreach ($listCBA0 as $reponse) {
                                              $id=$reponse['id'];
                                            echo "
                                              <tr>
                                              <td></td>
                                                ...
                                                <td>".$reponse['Employeur']."</td>
                                                <td>".$reponse['Disponibilite']."</td>
                                                <td style='background:green;'>".$reponse['Banque']."</td>
                                                <td><a href=\"?page=listegestionnaire\">Affecter</a></td>
                                                <td><a href=\"#MiseàJour$id\" data-toggle=\"modal\"  ><i class=\"glyphicon glyphicon-new-window\"></i>MiseàJour</a></td>
                                              </tr>";
                                            }
                                            foreach ($listCMS as $reponse) {
                                              $id=$reponse['id'];
                                            echo "
                                              <tr>
                                              <td></td>
                                                ...
                                                <td>".$reponse['Employeur']."</td>
                                                <td>".$reponse['Disponibilite']."</td>
                                                <td style='background:orange;'>".$reponse['Banque']."</td>
                                                <td><a href=\"?page=listegestionnaire\">Affecter</a></td>
                                                <td><a href=\"#MiseàJour$id\" data-toggle=\"modal\"  ><i class=\"glyphicon glyphicon-new-window\"></i>MiseàJour</a></td>
                                              </tr>";
                                               }
                                               foreach ($listCNCAS as $reponse) {
                                              $id=$reponse['id'];
                                            echo "
                                              <tr>
                                              <td></td>
                                                ...
                                                <td>".$reponse['Employeur']."</td>
                                                <td>".$reponse['Disponibilite']."</td>
                                                <td style='background:amber;'>".$reponse['Banque']."</td>
                                                <td><a href=\"?page=listegestionnaire\">Affecter</a></td>
                                                <td><a href=\"#MiseàJour$id\" data-toggle=\"modal\"  ><i class=\"glyphicon glyphicon-new-window\"></i>MiseàJour</a></td>
                                              </tr>";
                                                 }
                                                  foreach ($listECOBANK as $reponse) {
                                              $id=$reponse['id'];
                                            echo "
                                              <tr>
                                              <td></td>
                                                ...
                                                <td>".$reponse['Employeur']."</td>
                                                <td>".$reponse['Disponibilite']."</td>
                                                <td style='background:lime;'>".$reponse['Banque']."</td>
                                                <td><a href=\"?page=listegestionnaire\">Affecter</a></td>
                                                <td><a href=\"#MiseàJour$id\" data-toggle=\"modal\"  ><i class=\"glyphicon glyphicon-new-window\"></i>MiseàJour</a></td>
                                              </tr>";
                                                 }
                                                 foreach ($listPAMECAS as $reponse) {
                                              $id=$reponse['id'];
                                            echo "
                                              <tr>
                                              <td></td>
                                                ...
                                                <td>".$reponse['Employeur']."</td>
                                                <td>".$reponse['Disponibilite']."</td>
                                                <td style='background:cyan;'>".$reponse['Banque']."</td>
                                                <td><a href=\"?page=listegestionnaire\">Affecter</a></td>
                                                <td><a href=\"#MiseàJour$id\" data-toggle=\"modal\"  ><i class=\"glyphicon glyphicon-new-window\"></i>MiseàJour</a></td>
                                              </tr>";
                                                 }
